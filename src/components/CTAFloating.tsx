    ...
    <section className="py-16 md:py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          {/* Carte principale */}
          <motion.div 
            className="relative bg-gradient-to-br from-primary via-primary to-accent rounded-3xl overflow-hidden shadow-2xl"
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-12">
              ...
              <div className="flex justify-center mb-6">
                <motion.div 
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 text-white text-sm font-medium"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  viewport={{ once: true }}
          ...
          <motion.div 
            className="mt-6 p-4 bg-secondary/50 rounded-xl flex flex-col md:flex-row items-center justify-between gap-4"
            initial={{ opacity: 0 }}
